...
async function main() {
    ...
    for (const article of articles)
        await prisma.article.upsert({ where: { id: article.id }, update: article, create: article });
    const knowledge = [
    ...
    for (const entry of knowledge)
        await prisma.knowledgeArticle.upsert({ where: { id: entry.id }, update: entry, create: entry });
